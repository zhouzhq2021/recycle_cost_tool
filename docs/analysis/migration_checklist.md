...
| CM recovery | `CM Rec Par.` | ported | Plant parameters, equipment selections, OPEX baselines, feed costs, product prices, product outputs, CAPEX/OPEX, and revenue rows are Python-calculated. |
